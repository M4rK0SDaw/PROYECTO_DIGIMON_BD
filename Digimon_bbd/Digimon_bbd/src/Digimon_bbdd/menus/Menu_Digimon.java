        ...
        switch (numero) {
            ...
            case 2:
                ...
                if (Consultas.consultaCredencialesUsuario(nombre, contrasenya1)) {
                    ...
                    System.out.println("\n"
                            + "\u001B[32m El usuario se borró correctamente. \n");
            ...
            switch (numero) {
                ...
                case 6:
                    ...
                    if (!respuesta.equals("Y")) {
                        ...
                        System.out.println("\n Introduzca una opcición valida");
                    }
                    break;

                default:
                    System.err.println("Opción erronea, vuelva a seleccionar una de las opciones correctas");
                    break;
            }
